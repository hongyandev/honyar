...
document.write('<script src="../../static/js/weui.min.js?v=1.0.0.js"></script>');
document.write('<script src="../../static/js/jquery-2.1.4.js"></script>');
document.write('<script src="../../static/js/fastclick.js"></script>');
document.write('<script src="../../static/js/jquery-weui.js"></script>');
